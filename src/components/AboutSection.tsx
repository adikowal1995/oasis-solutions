      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Founded in 2018, TechFlow Solutions has been at the forefront of digital 
            transformation in the Middle East, delivering innovative solutions that drive business success.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-2xl font-bold text-brand-navy">2018</div>
                <div className="text-sm text-gray-600">Founded</div>
              </div>
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <Award className="h-8 w-8 text-brand-teal mx-auto mb-2" />
                <div className="text-2xl font-bold text-brand-navy">ISO</div>
        ...
        <div className="mt-16 text-center bg-gray-50 rounded-2xl p-8">
          ...
          <h3 className="text-2xl font-bold text-brand-navy mb-4">Our Locations</h3>
          <p className="text-gray-600 mb-6">
            Headquartered in Dubai with offices across the Middle East to serve you better.
          </p>
          <div className="grid md:grid-cols-3 gap-4 text-center">
            <div className="bg-white rounded-lg p-4">
              <div className="font-semibold text-brand-navy">Dubai, UAE</div>
              <div className="text-sm text-gray-600">Headquarters</div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="font-semibold text-brand-navy">Riyadh, Saudi Arabia</div>
              <div className="text-sm text-gray-600">Regional Office</div>
            </div>
            <div className="bg-white rounded-lg p-4">
              <div className="font-semibold text-brand-navy">Doha, Qatar</div>
