  ...
  const caseStudies = [
    {
      ...
      industry: "Retail",
      results: [
        { icon: <TrendingUp className="h-4 w-4" />, metric: "300% increase in online sales" },
        { icon: <Users className="h-4 w-4" />, metric: "50K+ new customers acquired" },
        { icon: <Clock className="h-4 w-4" />, metric: "6 months delivery time" }
      ],
    ...
    },
    {
      ...
      industry: "FinTech",
      results: [
        { icon: <Users className="h-4 w-4" />, metric: "200K+ daily active users" },
        { icon: <TrendingUp className="h-4 w-4" />, metric: "40% increase in digital transactions" },
        { icon: <Clock className="h-4 w-4" />, metric: "8 months development" }
      ],
    ...
    },
    {
      ...
      industry: "Healthcare",
      results: [
        { icon: <TrendingUp className="h-4 w-4" />, metric: "60% faster patient processing" },
        { icon: <Users className="h-4 w-4" />, metric: "10K+ patients managed monthly" },
        { icon: <Clock className="h-4 w-4" />, metric: "4 months implementation" }
      ],
    ...
    <section id="case-studies" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          <Button size="lg" className="bg-brand-teal hover:bg-brand-teal-light text-white">
