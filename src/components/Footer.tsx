        ...
        <div className="grid lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Empowering Middle Eastern businesses with innovative technology solutions 
              and exceptional service since 2018.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm text-gray-300">hello@techflow.ae</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-white placeholder:text-gray-400 focus:outline-none focus:border-brand-teal"
              />
